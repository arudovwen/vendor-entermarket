const projects = [
  {
    ...
    files: [
      { name: "EnterMarket Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "EnterMarket Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "EnterMarket Logo.Zip", size: "2.02 MB", link: "#" },
