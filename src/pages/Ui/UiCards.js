      ...
      <div className="page-content">
        ...
        <Container fluid={true}>
          ...
          <Row>
            ...
            <Col md={6} xl={3}>
              <Card>
                ...
                <CardImg className="img-fluid" src={img4} alt="EnterMarket" />
                <CardBody>
                  <CardText>
                    Some quick example text to build on the card title and make
                    up the bulk of the card&apos;s content.
          ...
          <Row>
            ...
            <Col lg={4}>
              <Card>
                <CardImg className="img-fluid" src={img6} alt="EnterMarket" />
                <CardImgOverlay>
          ...
          <Row>
            <Col sm={12}>
              ...
              <CardColumns>
                <Card>
                  <CardImg top src={img3} alt="EnterMarket" />
                  <CardBody>
                ...
                <Card>
                  <CardImg top src={img5} alt="EnterMarket" />
                  <CardBody>
                    <CardTitle>Card title</CardTitle>
                    <CardText>
                      This card has supporting text below as a natural lead-in
                ...
                <Card>
                  <CardImg top src={img7} alt="EnterMarket" />
                </Card>
