  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Images | EnterMarket - React Admin & Dashboard Template</title>
        </MetaTags>
        <Container fluid={true}>
          ...
          <Row>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  <CardTitle>EnterMarkets</CardTitle>
                  <CardSubtitle className="mb-3">
                  ...
                  <CardImg className="img-fluid" src={img2} alt="EnterMarket" />
                </CardBody>
              </Card>
            </Col>
          </Row>
